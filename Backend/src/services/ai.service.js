...
async function generateContent(prompt) {
    ...
    // Model Pool ordered by priority depending on API Key format (gemini-3.5-flash-lite prioritized first)
    const modelPool = isStandardKey 
        ? ["gemini-3.5-flash-lite", "gemini-3.5-flash", "gemini-2.5-flash", "gemini-1.5-flash", "gemini-2.0-flash", "gemini-3.6-flash", "gemini-1.5-pro"]
        : ["gemini-3.5-flash-lite", "gemini-3.5-flash", "gemini-3.6-flash", "gemini-2.5-flash", "gemini-1.5-flash", "gemini-2.0-flash", "gemini-1.5-pro"];
